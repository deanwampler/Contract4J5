...
public interface ExpressionInterpreter {
	...
	static enum InvalidTestExpression {
		...
		THIS_KEYWORD_WITH_NO_INSTANCE  ("\"$this\" present, but the \"instance\" is null. (The \"value\" of the instance can be null!) "),
		TARGET_KEYWORD_WITH_NO_TARGET  ("\"$target\" present, but the \"target\" is null. (The \"value\" of the instance can be null!) "),
		...
		RETURN_KEYWORD_WITH_NO_RETURN  ("\"$return\" present, but the \"result\" is null. (The \"value\" of the instance can be null!) "),
